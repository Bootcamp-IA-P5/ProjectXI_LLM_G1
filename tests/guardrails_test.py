...
from services.guardrails import ContentGuardrails, BiasDetector, SafetyLevel
...
class TestBiasDetection:
    ...
    def test_recomendaciones_generadas(self, bias_detector):
        ...
        # Asegurarse de que el resultado contiene recomendaciones
        assert resultado["has_bias"] == True